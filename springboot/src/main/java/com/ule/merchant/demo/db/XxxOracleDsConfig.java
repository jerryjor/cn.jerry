package com.ule.merchant.demo.db;
...
@Configuration
@MapperScan(basePackages = "com.ule.merchant.demo.db.dao.oracle.xxx", sqlSessionTemplateRef = "xxxOracleSst")
...
public class XxxOracleDsConfig {
    ...
    public SqlSessionFactory getSqlSessionFactory(@Qualifier("xxxOracleDs") DataSource dataSource) throws Exception {
        ...
        bean.setMapperLocations(new PathMatchingResourcePatternResolver()
                .getResources("classpath:com/ule/merchant/demo/oracle/xxx/**/*Mapper.xml"));
