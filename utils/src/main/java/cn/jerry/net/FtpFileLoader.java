...
public class FtpFileLoader {
	 ...
	 * @throws IOException
	 */
	public byte[] download(String host, Integer port, String user, String pwd, String baseDir,
		...
		for (FTPFile file : files) {
			try {
				if (new String(file.getName().getBytes(charset), CHARSET_LOCAL)
						.equals(fileName)) {
					needFile = file;
					break;
				}
	 ...
	 * @throws IOException
	 */
	private void connect(String host, Integer port, String user, String pwd) throws IOException {
		if (port != null) {
