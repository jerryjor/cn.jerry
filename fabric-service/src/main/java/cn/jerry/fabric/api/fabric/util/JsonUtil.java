...
public class JsonUtil {
     ...
     * @throws IOException
     */
    public static <K1, V1> ArrayList<HashMap<K1, V1>> toListFillWithMap(String json, Class<K1> classOfK1,
     ...
     * @throws IOException
     */
    public static <K, K1, V1> HashMap<K, HashMap<K1, V1>> toMapFillWithMap(String json, Class<K> keyCls, Class<K1> key1Cls,
